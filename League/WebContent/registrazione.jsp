...
<f:view>
<h:form>
    <div>Nome: <h:inputText value="#{responsabileController.nome}" 
                     required="true"
                     requiredMessage="Name is mandatory"
                     id="name"/> <h:message for="name" />
	</div>
    <div>Cognome: <h:inputText value="#{responsabileController.cognome}" 
                     required="true"
	...
	<div>
		<h:commandButton value="Registrati"  action="#{responsabileController.registraResponsabile}"/>
